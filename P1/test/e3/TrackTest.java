...
class TrackTest {
    ...
    void testToString(){
        String s = """
                ...
                Title: Penny Lane
                Duration: 180
                Recording ID: 5a6becfb-07e3-4286-8de0-5b4fa826f3f2
                """;
        assertEquals(s, beatlesPennyLanePromo01.toString());
    }
    ...
    void testEquals() {
        ...
        assertFalse(beatlesSFFPennyLane01.equals(null)); //Da warning ya que siempre es false, pero es necesario para comprobar todos los posibles casos del equals
        assertEquals(beatlesSFFPennyLane02,beatlesSFFPennyLane02); //Da warning ya que comparar el objeto consigo mismo dará que son iguales
    }
