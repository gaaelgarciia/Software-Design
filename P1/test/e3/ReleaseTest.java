...
class ReleaseTest {
    ...
    void testEquals() {
        ...
        assertEquals(beatlesSFFPennyLane, beatlesSFFPennyLane); //Da warning ya que comparar el objeto consigo mismo dará que son iguales
        assertFalse(beatlesSFFPennyLane.equals(null)); //Da warning ya que siempre es false, pero es necesario para comprobar todos los posibles casos del equals
    ...
    @Test
    void get(){
        assertEquals(madonnaIntoTheGrooveUSMaxiSingle.getId(),"d0e62810-fcab-443e-b3ef-398db6cec5eb");
        assertEquals(madonnaIntoTheGrooveUSMaxiSingle.getArtist(),"Madonna");
        assertEquals(madonnaIntoTheGrooveUSMaxiSingle.getTitle(),"Into the Groove (US 12\" Single)");

        StringBuilder s=new StringBuilder();
        s.append("[Position: A1\nArtist: Madonna\nTitle: Into the Groove\nDuration: 280\nRecording ID: 986645ce-32d0-42ba-999a-7faf2603aa7e\n, Position: B1\nArtist: Madonna\nTitle: Angel (12\" Dance Mix)\nDuration: 375\nRecording ID: 74e2ab8f-56f2-4b9c-ad35-336c73cd73e0\n]");
        assertEquals(madonnaIntoTheGrooveUSMaxiSingle.getTrackList().toString(),String.valueOf(s));
        assertThrows(IllegalArgumentException.class, () -> madonnaIntoTheGrooveUSMaxiSingle.addTrack(null));

    }

    @Test
    void toStringtest(){
        assertEquals(madonnaIntoTheGrooveUSMaxiSingle.toString(),"ID: d0e62810-fcab-443e-b3ef-398db6cec5eb\nTitle: Into the Groove (US 12\" Single)\nMainArtist: Madonna\nTracklist:\nPosition: A1\nArtist: Madonna\nTitle: Into the Groove\nDuration: 280\nRecording ID: 986645ce-32d0-42ba-999a-7faf2603aa7e\n\nPosition: B1\nArtist: Madonna\nTitle: Angel (12\" Dance Mix)\nDuration: 375\nRecording ID: 74e2ab8f-56f2-4b9c-ad35-336c73cd73e0\n\n");
    }
}